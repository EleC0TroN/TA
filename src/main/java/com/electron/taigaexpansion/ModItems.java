...
public class ModItems {
    ...
    public static final RegistryObject<BlockItem> MINI_CAULDRON = ITEMS.register("mini_cauldron", () -> new BlockItem(ModBlocks.MINI_CAULDRON.get(), new Item.Properties().group(ItemGroup.DECORATIONS)));
