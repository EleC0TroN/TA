...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> TEA_POT = BLOCKS.register("tea_pot", () -> new TeaPotBlock(TeaPotBlock.Properties.create(Material.ROCK, MaterialColor.BROWN).hardnessAndResistance(2.0F).notSolid()));
